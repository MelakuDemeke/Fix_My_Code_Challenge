...
class User:
    def __init__(self):
        ...
        self.__password = None  # Initialize as None here

    @property
    def password(self):
        return None if self.__password is None else self.__password

    @password.setter
    def password(self, pwd):
        if pwd is None or not isinstance(pwd, str):  # Use isinstance to check type
